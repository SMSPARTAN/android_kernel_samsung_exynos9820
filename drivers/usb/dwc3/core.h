...
#else
static inline int dwc3_host_init(struct dwc3 *dwc) { return 0; }
...
static inline int dwc3_gadget_get_link_state(struct dwc3 *dwc) { return 0; }
...
static inline int
dwc3_send_gadget_ep_cmd(struct dwc3_ep *dep, unsigned cmd,
                        struct dwc3_gadget_ep_cmd_params *params) {
  return 0;
}
static inline int dwc3_send_gadget_generic_command(struct dwc3 *dwc, int cmd,
                                                   u32 param) {
  return 0;
}
...
#else
static inline int dwc3_drd_init(struct dwc3 *dwc) { return 0; }
...
#else
static inline int dwc3_gadget_suspend(struct dwc3 *dwc) { return 0; }

static inline int dwc3_gadget_resume(struct dwc3 *dwc) { return 0; }
...
#else
static inline int dwc3_ulpi_init(struct dwc3 *dwc) { return 0; }
